...
# models_dir = '/home/liuz/xingy_project/home/liuz/xingy_project/models1/'  # 模型保存路径
# save_dir = '/home/liuz/xingy_project/home/liuz/xingy_project/output1/'  # 结果保存路径
...
models_dir = os.path.join(base_dir, 'models1')  # 模型保存路径
save_dir = os.path.join(base_dir, 'output1')  # 输出保存路径
...
for i in range(task_num):
    ...
    if i < task_num - 1:
        merged_train_target, merged_train_data = extract_dataset(i, base_classes, incre_classes, num_extract, data_dir, istype, merged_train_target, merged_train_data)
