...
# models_dir = '/home/liuz/xingy_project/home/liuz/xingy_project/models3/'  # 模型保存路径
# save_dir = '/home/liuz/xingy_project/home/liuz/xingy_project/output3/'  # 结果保存路径
...
models_dir = os.path.join(base_dir, 'models3')  # 模型保存路径
save_dir = os.path.join(base_dir, 'output3')  # 输出保存路径
...
base_classes = 5
incre_classes = 5  # 每个任务的新增类别数
num_epochs_base = 10  # 迭代轮次
num_epochs_incre = 10
...
for i in range(task_num):
    if i == 0:
        ...
        num_classes = num_classes + base_classes
    ...
    if i < task_num - 1:
        merged_train_target, merged_train_data = extract_dataset(i, base_classes, incre_classes, num_extract, data_dir,
                                                                 istype, merged_train_target, merged_train_data)
